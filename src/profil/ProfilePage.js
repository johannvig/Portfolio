    ...
    <div className="profile-container">
      ...
      <main className="profile-main">
        <section className="profile-about">
          ...
          <p>J’ai débuté mon parcours académique en informatique à l'IUT de Laval avant de poursuivre mes études à l'Université du Québec à Chicoutimi (UQAC) en tant qu'étudiante dans un programme bi-diplômant. Actuellement en 1ère année d'ingénieur logiciel à l'IMT Atlantique, je m'immerge pleinement dans chaque projet en me concentrant sur un code propre et des solutions efficaces.</p>
